...
=======
<<<<<<< HEAD
>>>>>>> 28064054b729cfc898782d309a92b53392e4a6ce
      {
        question:
...
=======
      ...
      },
      {
        ...
        options: [
          ...
          "Radial nerve",
          "Musculocutaneous nerve",
>>>>>>> 50224dcccf5ced032416488c5b10e6e0da41be93
        ],
        answer: 2,
      },
      {
...
=======
  ...
  surgery: {
    "Set-1": [
      ...
      {
        // 6
        question: "Identify the instrument shown in the given image.",
        options: [
          "Veress needle",
          "Sprotte needle",
          "Quincke needle",
      ...
      },
      {
        ...
        question:
          "Child is having cystic swelling in the floor of the mouth which is bluish red in color for the past 5 years. It shows positive transillumination. Diagnosis is:",
        options: ["Pleomorphic adenoma", "Dermoid cyst", "Ranula","Cystic hygroma"],
        answer: 2, // Correct answer: Cystic hygroma
      },
      {
        // 18
    ...
    "Set-2": [
      ...
      },
      {
        ...
        answer: 3, // Correct answer: Retrocaval ureter
      },
      {
        // 54
        question:
          "Which of the following is the most likely diagnosis for a patient with sudden onset severe headache, vomiting, and neck stiffness after a head injury?<br><img src='images/s54.png' alt='Vertebral Level Image' width='98%' style='max-height: 350px;'/>",
        options: [
          "Epidural hematoma",
        ...
        answer: 1, // Correct answer: Subarachnoid hemorrhage (SAH)
      },
      {
        // 55
        question:
          "A GT image of a patient shows dilated renal pelvis. What is the most likely diagnosis?",
        options: [
          "Hydronephrosis",
          "Horseshoe kidney",
          "Renal cyst",
      ...
      },
      {
        // 56
        question:
          "A patient presents with bilateral lower limb edema and reduced urine output. Which of the following conditions is least likely to cause bilateral hydronephrosis?",
        options: [
      ...
      },
      {
        // 57
        question:
          "A 36-year-old male presents with severe upper abdominal pain radiating to the back, elevated serum amylase, and lipase. What is the most likely diagnosis?",
        options: [
          "Acute pancreatitis",
          "Cholecystitis",
          "Gastric ulcer",
      ...
      },
      {
        // 58
        question:
          "A patient with long-term use of chewing tobacco presents with white patches in the mouth that cannot be scraped off. What is the most likely diagnosis?",
        options: [
          "Oral thrush",
          "Leukoplakia",
          "Oral lichen planus",
        ...
        answer: 1, // Correct answer: Leukoplakia
      },
      {
        // 72
        question:
      ...
      },
      {
        ...
        answer: 1, // Correct answer: Proximal obstruction in the small intestine
      },
      {
        // 81
        question: "What is the site of maximum pain in acute appendicitis?",
    ...
    "Set-3": [
      ...
      // 102
{
  question: "A 20-year-old female diagnosed with adenocarcinoma of the stomach presents with the following lesion on examination. What is the diagnosis?<br><img src='images/s102.png' alt='Vertebral Level Image' width='98%' style='max-height: 350px;'/> ",
  options: [
    "Sister Mary Joseph nodule",
    "Busacca nodule",
    "Infected umbilical hernia",
  ...
  answer: "0",
    ...
    "Set-4": [//ques-compleated , img
      ...
      {
        // 156
        question: "Identify the structure shown in the given picture<br><img src='images/s156.png' alt='Vertebral Level Image' width='98%' style='max-height: 350px;'/>",
        options: [
          "Appendix",
          "Meckel diverticulum",
          "Diverticulosis",
    ...
    "Set-5": [//ques-compleated, img
      ...
      {
        // 210
        question: "The following image shows:<br><img src='images/s210.png' alt='Vertebral Level Image' width='98%' style='max-height: 350px;'/>",
        options: [
          "a. Rectal prolapse",
          "b. Fistula in ano",
          "c. Perianal abscess",
      ...
      {
        // 214
        question: "What is the diagnosis?<br><img src='images/s214.png' alt='Vertebral Level Image' width='98%' style='max-height: 350px;'/>",
        options: [
          "a. Perforation by Ascariasis",
          "b. Volvulus by Ascariasis",
          "c. Ascending cholangitis by Ascariasis",
    ...
    "Set-6": [//ques-compleated, img
      ...
      {//252
        question: "What is the probable diagnosis?<br><img src='images/s252.png' alt='Vertebral Level Image' width='98%' style='max-height: 350px;'/>",
        options: [
          "Mastitis",
          "Mondor disease",
          "Cystosarcoma phyllodes",
      ...
      // 266
{
  question: "Which of the following is the most useful investigation for thyroid function?",
  options: [
    "TSH",
    "T3",
    "T4",
...
// 269
{
  question: "Which is the most common nerve to be damaged in thyroid surgery?",
  options: [
    "Recurrent laryngeal nerve",
    "Inferior laryngeal nerve",
    "External branch of superior laryngeal nerve",
...
// 270
{
  question: "Which is the tumor marker for medullary carcinoma of thyroid?",
  options: [
    "Albumin",
    "TSH",
    "Thyroglobulin",
...
// 274
{
  question: "A male patient with euthyroid state presents with the following condition. What is the diagnosis?<br><img src='images/s274.png' alt='Vertebral Level Image' width='98%' style='max-height: 350px;'/>",
  options: [
    "Thyroglossal cyst",
    "Multiple nodular goiter",
    "Solitary thyroid nodule",
...
{//275
  ...
  answer: 2,
      ...
      {//283
        "question": "A 14-year-old boy presented to the OPD. His scrotum was empty on the left side. On clinical examination, the left testis was found in the superficial inguinal pouch. What is the most likely diagnosis?",
        "options": [
          "Cryptorchidism",
          "Left undescended testis",
          "Left ectopic testis",
      ...
      {//284
        "question": "A 25-year-old male presented with vague dragging sensation in the scrotum. On clinical examination, a bag of worm feel was noted in the scrotum on the left side. However, the left testis was normal. What can be the likely diagnosis?",
        "options": [
          "Left hydrocele",
          "Inguinal hernia",
          "Epididymoorchitis",
      ...
      {//286
        "question": " Which of the following isotope is used in the treatment of prostate cancer?",
        "options": [
          "I-131",
          "I-125",
          "I-123",
      ...
      {//287
        "question": " A patient presented with herniation of intestine loop which passes along the spermatic cord and reaches till the cremaster muscle. What is the type of hernia?",
        "options": [
          "Femoral hernia",
          "Indirect inguinal hernia",
          "Direct inguinal hernia",
...
{//288
  question: "A 5-month-old baby was brought to the hospital with bilateral undescended testis. What is the most appropriate treatment?",
  options: [
    "Immediate orchidopexy",
    "Wait and watch for spontaneous resolution",
    "GnRH for one month and if no descent then surgical treatment",
...
{//289
  question: "A 40-year-old male patient presented with testicular swelling and one mass over supraclavicular area and one over the umbilical region. What is the diagnosis? (Most Recent Question Dec. 2021)",
  options: [
    "Testicular tumor",
    "Testicular torsion",
    "Spermatocele",
...
{//290
  question: "A 30-year-old male patient presented with scrotal enlargement. On work-up, LDH was significantly raised with normal alpha-feto protein and hCG. Histopathology is shown below. What is the most likely diagnosis? <br><img src='images/s290.png' alt='Vertebral Level Image' width='98%' style='max-height: 350px;'/>",
  options: [
    "Teratoma",
    "Seminoma",
    "Choriocarcinoma",
...
{//291
  ...
  answer: 2,
    ...
    // 292
{
  question: "A 50-year-old patient felt heaviness in the left scrotum. He suspected he had developed cancer, so he came to the emergency department. There was no pain or tenderness. Transillumination test was negative. What is the most likely diagnosis?",
  options: [
    "Acute epididymo-orchitis",
    "Vaginal hydrocele",
    "Varicocele",
...
// 293
{
  question: "Which of the following viruses is responsible for causing Orchitis?",
  options: [
    "Adeno virus",
    "Herpes virus",
    "Polio virus",
...
// 294
{
  question: "An elderly male is having metastasis in the lumbar vertebra and pelvic bone. What is the most likely diagnosis in this patient?",
  options: [
    "Testicular cancer",
    "Lung cancer",
    "Colon cancer",
...
// 295
{
  question: "In a newborn baby with empty scrotum, testis was found to be lying close to the peritoneum. Which of the following may help in the testis reaching into the scrotum?",
  options: [
    "GnRH analogues",
    "Testosterone",
    "Cold compresses",
...
// 297
{
  question: "A boy in the gym lifted the equipment and suddenly felt pain in the groin. He came to the hospital. On examination, swelling was felt in the left inguinal canal. What should be the next step?",
  options: [
    "NSAIDs and send the patient home",
    "Immediate exploration",
    "FNAC and USG",
...
// 298
{
  question: "A patient with irreducible groin hernia was brought to the emergency. What should be the next step?",
  options: [
    "Exploratory laparotomy",
    "Attempt Reduction followed by elective surgery",
    "Attempt Reduction in emergency surgery",
  ...
  answer: 1,
    ...
    // 299
{
  question: "In a newborn male baby, the mother found an empty scrotum. On examination, the left testis is in the inguinal region and the right testis is in the perineum. Which of the following is correct? (Most Recent Question Aug 2020)",
  options: [
    "Right testis is undescended and left testis is ectopic",
    "Left testis is undescended and right testis is ectopic",
    "Both testes are undescended",
...
// 300
{
  question: "Identify the abnormal condition given below.<br><img src='images/s300.png' alt='Vertebral Level Image' width='98%' style='max-height: 350px;'/>",
  options: [
    "Testicular torsion",
    "Hydrocele",
    "Varicocele",
  ...
  answer: 0,
    ...
    "Set-7": [
      ...
      },
      {
        ...
        answer: 3, // Correct answer: Long-standing hernia decreases chances of incarceration
      },
      {
        // 309
        question: "The content of Littre's hernia is?",
      ...
      },
      {
        ...
        answer: 1, // Correct answer: Schistosomiasis
      },
      {
        // 323
        question:
      ...
      },
      {
        ...
        answer: 0, // Correct answer: Partial nephrectomy
      },
      {
        // 325
        question:
      ...
      },
      {
        ...
        answer: 0, // Correct answer: Paraphimosis
      },
      {
        // 336
        question:
      ...
      {
        // 338
        question: "What is the diagnosis based on the given image of IVP?",
        options: [
          "Ureterocele",
          "Ectopic ureteric orifice",
          "PUJ obstruction",
      ...
      },
      {
        ...
        answer: 3, // Correct answer: Cystine
      },
    ],
    "Set-8": [
      //ques-compleated
      ...
      },
      {
        ...
        answer: 0, // Correct answer: Misplaced Cu-T 380Ag
      },
      {
        // 354
        question:
      ...
      },
      {
        ...
        answer: 3, // Correct answer: Right encysted hydrocele of cord
      },
      {
        // 358
        question:
        ...
        answer: 1, // Correct answer: Right strangulated inguinal hernia
      },
      {
        // 359
        question:
      ...
      },
      {
        ...
        answer: 2, // Correct answer: Uterine fibroid
      },
      {
        // 365
        question:
      ...
      },
      {
        ...
        answer: 3, // Correct answer: Anterior abdominal wall
      },
      {
        // 372
        question:
      ...
      {
        // 384
        question: "Which of the following is correct about the image given",
        options: [
          "Horse shoe kidney",
          "Undescended left kidney",
          "Congenital absent left kidney",
      ...
      {
        // 385
        question: "The given picture shows",
        options: [
          "Renal cell cancer",
          "Hydronephrosis",
          "Polycystic kidneys",
        ...
        answer: 1, // Correct answer: Hydronephrosis
      },
      {
        // 386
        question: "What does the given picture show?",
        options: [
          "Foreign body",
          "Bladder stone",
          "Bladder diverticulum",
        ...
        answer: 3, // Correct answer: Fecolith
      },
      {
        // 387
      ...
      },
      {
        ...
        answer: 2, // Correct answer: Inguinal lymph node metastasis inoperable
      },
      {
        // 389
        question:
      ...
      },
      {
        ...
        answer: 1, // Correct answer: ERCP and stenting
      },
      {
        // 394
        question: "Which of the following is a type III choledochal cyst?",
        options: ["A", "B", "C", "D"],
        answer: 2, // Correct answer: C
      },
      {
    ...
    "Set-9": [
      //ques-compleated
      {
        // 401
        question:
          "A pregnant woman underwent ultrasound during follow-up. The incidental finding is given in the image. What is the diagnosis?",
        options: [
          "Simple hepatic cyst",
          "Multiple gallstones",
          "Amoebic liver abscess",
      ...
      },
      {
        // 403
        question:
          "A 45-year-old male patient presented with abdominal pain and hepatomegaly. Ultrasound image is given below. What is the most probable diagnosis?",
        options: [
          "Hydatid cyst",
          "Amebic liver abscess",
          "Pyogenic liver abscess",
      ...
      },
      {
        // 405
        question:
          "The image of gallbladder specimen is given below. What is the most probable diagnosis?",
        options: [
          "Carcinoma gallbladder",
          "Mixed gallbladder stone",
          "Gallbladder polyp",
      ...
      {
        // 408
        question: "Comment on the image shown below.",
        options: [
          "Percutaneous Transhepatic cholangiogram",
          "T tube cholangiogram",
          "E.R.C.P",
        ...
        answer: 1, // Correct answer: T tube cholangiogram
      },
      {
        // 409
        question:
      ...
      {
        // 411
        question: "A patient comes with RUQ pain. The USG image shows?",
        options: [
          "Cholelithiasis",
          "Cholecystitis",
          "Cholangiocarcinoma",
        ...
        answer: 1, // Correct answer: Cholecystitis
      },
      {
        // 412
        question:
        ...
        answer: 3, // Correct answer: Percutaneous aspiration and infusion of scolicidal agents
      },
      {
        // 413
        question: "Aflatoxin leads to?",
      ...
      },
      {
        ...
        answer: 1, // Correct answer: Exploratory Laparotomy
      },
      {
        // 415
        question:
        ...
        answer: 0, // Correct answer: Pyogenic liver abscess
      },
      {
        // 416
        question: "Anchovy sauce pus is seen in:",
      ...
      },
      {
        // 431
        question:
          "Which of the following is the most appropriate treatment for the given condition?",
        options: [
          "Sclerotherapy",
          "Incision and drainage",
          "Radiotherapy",
        ...
        answer: 1, // Correct answer: Incision and drainage
      },
      {
        // 432
        question:
      ...
      },
      {
        // 434
        question:
          "What is the preferred management of the given condition in the image?",
        options: [
          "Surgical excision",
          "Intralesional steroids",
          "Chemotherapy",
      ...
      },
      {
        // 436
        question:
          "The image of patient after a lifesaving procedure is given. Identify the procedure?",
        options: [
          "Nasotracheal intubation",
          "Needle cricothyrodotomy",
          "Endotracheal intubation",
        ...
        answer: 1, // Correct answer: Needle cricothyrodotomy
      },
      {
        // 437
        question:
      ...
      },
      {
        ...
        answer: 0, // Correct answer: Mainly a retention cyst
      },
      {
        // 440
        question: "All are premalignant conditions of the oral cavity, EXCEPT:",
        ...
        answer: 0, // Correct answer: Chronic hyperplastic candidiasis
      },
      {
        // 441
        question: "Comment on the diagnosis of this 60-year-old man.",
        options: [
          "Basal cell Cancer",
          "Plunging Ranula",
          "Epulis",
      ...
      },
      {
        ...
        answer: 0, // Correct answer: Superficial spreading
      },
      {
        // 443
        question:
      ...
      },
      {
        ...
        answer: 1, // Correct answer: Pain and paraesthesia in median nerve distribution
      },
      {
        // 445
        question: "Pott puffy tumor is seen at:",
      ...
      },
      {
        ...
        answer: 1, // Correct answer: Glioblastoma multiform
      },
      {
        // 450
        question: "Stereotactic radiotherapy is used for treatment of?",
    ...
    "Set-10": [
      ...
      },
      {
        ...
        answer: 0, // Correct answer: Branchial sinus
      },
      {
        // 458
        question:
      ...
      },
      {
        // 462
        question:
          "A male patient with history of smoking presented with black necrotic index finger as shown below. What is the diagnosis?",
        options: [
          "Ainhum",
          "Raynaud's phenomenon",
          "Fournier's gangrene",
      ...
      },
      {
        ...
        answer: 3, // Correct answer: Fat embolism
      },
      {
        // 464
        question:
      ...
      {
        // 465
        question: "What is the origin of ulcer, given in the image?",
        options: [
          "Venous ulcer",
          "Arterial ulcer",
          "Diabetic ulcer",
        ...
        answer: 1, // Correct answer: Arterial ulcer
      },
      {
        // 466
        question:
      ...
      },
      {
        // 467
        question:
          "A 60-year-old patient presents with restricted ambulation and prolonged bed rest due to acute lumbago, presenting with severe pain in left leg below the knee. On examination, discoloration of the left calf with significantly increased girth is noted. What is the clinical diagnosis?",
        options: [
          "Acute lymphangitis",
          "Superficial migratory thrombophlebitis",
          "Deep vein thrombosis",
      ...
      },
      {
        ...
        answer: 3, // Correct answer: Suppurative and invasive
      },
      {
        // 470
        question:
          "Long term diabetic patient walked barefoot a few miles on hot sand. He developed blisters on feet and legs. What is the most probable diagnosis?",
        options: [
          "Diabetic foot",
          "Necrotizing fasciitis",
          "Burn",
      ...
      },
      {
        ...
        answer: 1, // Correct answer: Brodie Trendelenburg test II
      },
      {
        // 472
        question:
        ...
        answer: 2, // Correct answer: Bazin ulcer
      },
      {
        // 473
        question:
      ...
      },
      {
        ...
        answer: 1, // Correct answer: On first step of walking
      },
      {
        // 477
        question:
      ...
      },
      {
        ...
        answer: 3, // Correct answer: Phlebitis migrans
      },
      {
        // 481
        question:
        ...
        answer: 2, // Correct answer: Sapheno-femoral flush ligation
      },

      {
        ...
        question: "Thromboangiitis obliterans involves?",
        options: ["Arteries", "Veins", "Nerves", "All of these"],
        answer: 0, // Correct answer: Arteries
      },
...

      {
        // 487
        question:
          "A patient suffered from injury 3 days ago following which he was brought to tertiary care hospital. What would be the initial treatment in this patient?",
        options: [
          "Debridement and rotational advancement flap closure",
          "Debridement and primary closure",
          "Amputation",
      ...
      },
      {
        // 488
        question:
          "Which of the following incisions is cosmetically preferred for appendicectomy?",
        options: ["A", "B", "C", "D"],
        answer: 0, // Correct answer: A
      },
      {
        // 489
        question:
          "A 60-year-old female presented in a state of shock and abdominal distension. She has a history of prolonged use of NSAIDs. Chest X-ray is given below. Identify the condition.",
        options: [
          "Pneumothorax",
          "Pleural effusion",
          "Hydropneumothorax",
      ...
      },
      {
        // 490
        question:
          "What is the cause of cannon ball appearance on chest X-ray as shown below?",
        options: [
          "Tuberculosis",
          "Carcinoma lung",
          "Lung metastasis",
      ...
      },
      {
        // 492
        question:
          "A 50-year-old patient presented with a history of chronic cough, occasional hemoptysis, and weight loss. Golden 'S' sign was seen on the chest X-ray. What is the diagnosis?",
        options: [
          "Tuberculosis",
          "Bronchogenic carcinoma",
          "Mesothelioma",
      ...
      },
      {
        // 493
        question:
          "A child was brought to the emergency by the mother with difficulty in swallowing for the past few hours. The child was able to speak. X-ray was taken. Identify the location of foreign body.",
        options: ["Esophagus", "Trachea", "Mediastinum", "Artifact of X-ray"],
        answer: 0, // Correct answer: Esophagus
      },
      {
        ...
        question: "Pressure sores are formed when the pressure is above:",
        options: ["5 mm Hg", "10 mm Hg", "20 mm Hg", "30 mm Hg"],
        answer: 2, // Correct answer: 20 mm Hg
      },
      {
        // 491
        question: "Popcorn calcification on chest X-ray is seen in:",
      ...
      },
      {
        // 499
        question:
          "A chronic smoker presented to the emergency. His X-ray chest was done which showed the following. Probable diagnosis in this patient:",
        options: [
          "Pneumothorax",
          "Tension pneumothorax",
          "Hemothorax",
      ...
      },
      {
        // 500
        question:
          "What is the probable cause of the condition shown in the given X-ray?",
        options: [
          "Pleural effusion",
        ...
        answer: 0, // Correct answer: Pleural effusion
      },
    ],
    medicine: [
>>>>>>> 50224dcccf5ced032416488c5b10e6e0da41be93
